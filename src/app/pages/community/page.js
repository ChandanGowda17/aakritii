  ...
  const programs = [
    {
      ...
      description:
"Creating opportunities for individuals and families to thrive through education, livelihood support, leadership development, and collective action.By encouraging participation and collaboration, we help communities become active drivers of positive social change.",
      stat1: "20K+",      
  ...
  const activeProgram =
    ...
    const cards = [
    {
      title: "Learn ",
      description:
        "Access to education, knowledge and skills that unlock opportunities.",
    },
    {
      title: "Thrive",
      description:
        "Health, well-being and supportive environments to lead productive lives.",
    },
    {
      title: "Participate",
      description:
        "Civic engagement, volunteerism and active community involvement.",
    },
    {
      title: "Empower",
      description:
        "Confidence, leadership and self-reliance for community-led progress.",
    },
  ...
  return (
    ...
    >
      ...
      <img src="/img/community-3.png" alt="Community" className="absolute inset-0 w-full h-full object-cover" />
...
<div className="hero-copy lg:col-span-8 flex flex-col gap-6 text-left w-full pt-20 lg:pt-28">
  ...
  <p className="mt-4 text-[0.95rem] sm:text-[1.05rem] text-neutral-300 leading-relaxed max-w-2xl font-light">
    Building stronger and self-reliant communities through skill development,
    awareness initiatives, volunteer engagement, and grassroots participation.

    <br /><br />

    We work alongside local communities to identify challenges, strengthen
    capacities, and create sustainable solutions that improve livelihoods,
    promote social inclusion, and foster long-term development.
  </p>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <article className="rounded-[20px] border border-[#E2D2C0] bg-[#FFFCF8]" style={{ padding: "clamp(32px, 5vw, 56px)" }}>
              ...
              <h2 className="mt-6 font-serif text-3xl leading-tight text-[#7A3F1E] md:text-4xl">
                An inclusive, empowered society
              </h2><br />

              <p className="mt-7 text-lg leading-8 text-[#4F4035] md:text-xl md:leading-9">
                To build an inclusive, empowered and sustainable society where every
                individual has access to the opportunities, resources and support needed
            ...
            <article className="rounded-[20px] bg-[#7A4724] text-[#F4E6D8]" style={{ padding: "clamp(32px, 5vw, 56px)" }}>
              ...
              <ul className="mt-8 space-y-4 text-base font-semibold leading-7 md:text-lg">
                {[
                  "Promote quality education and child development.",
                  "Enhance health, well-being and community care.",
                  "Encourage environmental responsibility.",
                  "Empower communities through participation.",
                  "Inspire volunteerism and active citizenship.",
                ].map((item) => (
      ...
      <div className="site-container mb-20 text-left"><br/> <br/>
        ...
        <div className="pt-16 pb-10 justify-start">
          ...
          <h1 className="mt-6 text-[#7A4A2B] text-4xl md:text-5xl lg:text-6xl font-light font-serif leading-[1.05]">
           Holistic support across every <br/>stage of life.
          </h1>

...
<section className="bg-[#F8F1E6] border-t border-[#E6DACB] w-full" style={{ paddingTop: '86px' }}>
      ...
      <div className="site-container pb-20 md:pb-28">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="overflow-hidden rounded-[20px] bg-[#E8DCCE] shadow-sm order-1 lg:order-1 transition-all duration-300 hover:scale-105 hover:shadow-xl">
            <img
              src="/img/news-2.png"
...
<div className="overflow-hidden rounded-[20px] bg-[#E8DCCE] shadow-sm order-1 lg:order-2 transition-all duration-300 hover:scale-105 hover:shadow-xl">
            <img
              src="/img/news-3.png"
              alt="Women participating in a community development activity"
              className="h-[320px] w-full object-cover md:h-[370px]"
